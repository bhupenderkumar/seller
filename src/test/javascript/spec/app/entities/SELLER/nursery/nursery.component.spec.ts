...
import { NurseryComponent } from 'app/entities/SELLER/nursery/nursery.component';
...
describe('Component Tests', () => {
  describe('Nursery Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nurseries && comp.nurseries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
