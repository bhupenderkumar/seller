...
import { Quote1Component } from 'app/entities/SELLER/quote-1/quote-1.component';
...
describe('Component Tests', () => {
  describe('Quote1 Management Component', () => {
    let comp: Quote1Component;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(Quote1Component, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.quote1s && comp.quote1s[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
